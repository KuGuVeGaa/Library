                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> Here is a added Category</p>
                                    ...
                                    @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td class="text-primary">
                                                <a href="{{route('admin.category.edit',['id'=>$value['id']])}}">Edit</a>
                                            </td>
                                            <td class="text-primary">
                                                <a href="{{route('admin.category.delete',['id'=>$value['id']])}}">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
...
@section('scripts')
    <script>
        ...
        function routing() {
            location.href = "{{route('admin.category.create')}}";
        }
    </script>
@endsection
