            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.category.edit.post',['id'=>$data[0]['id']])}}" method="post" class="table table-bordered table-hover dataTable">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Category Edit</button>
